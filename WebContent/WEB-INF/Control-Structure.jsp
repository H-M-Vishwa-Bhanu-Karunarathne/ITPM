...
<link type="text/css"
	...
	rel="stylesheet">
<link type="text/css"
	href="${pageContext.request.contextPath}/assets/css/Control-Structure.css"
	rel="stylesheet">
...
<body>
			...
			<div class="row">
				...
				<div class="col-2">
					<div id="wb_Image1"
						...
						<img
							src="${pageContext.request.contextPath}/assets/images/awan.png"
							id="Image1" alt="">
					</div>
				</div>
				<div class="col-3"></div>
		...
		<div id="LayoutGrid7">
			<div class="row">
				<div class="col-1">
							...
							<div id="LayoutGrid8">
								<div class="row">
									...
									<div class="col-2">
										...
										<div id="FileUpload1" class="input-group"
											...
											<input class="form-control" type="text" readonly
												id="file-upload-path"> <label
												class="input-group-btn"> <input type="file"
												name="FileUpload1" id="FileUpload1-file"
												accept=".java,.cpp,.zip" style="display: none;"><span
									...
									<div class="col-3">
										<div id="wb_Text2">
											<span
												style="color: #FF0000; font-family: Arial; font-size: 27px;"><strong>(C++/Java/Zip
													only)</strong></span>
										</div>
									</div>
									<div class="col-4">
					...
					<form action="${pageContext.request.contextPath}/UpdateWeights"
						method="post">
						<div class="col-1">
							<table
								style="display: table; width: 100%; height: 50px; z-index: 14;"
								id="Table1">
								<tr>
									<td width="80%" class="cell0 table-header-cell">Control Structure</td>
									<td class="cell0 table-header-cell">Weight</td>
								</tr>
								<tr>
									<td width="50%" class="cell0 table-header-cell">A conditional control structure such as an 'if' or 'else-if' condition</td>
									<td class="cell0 table-header-cell"><input type="text" name="if" value="${ifWeight}"></td>
								</tr>
								<tr>
									<td width="50%" class="cell0 table-header-cell">An iterative control structure such as a 'for', 'while', or 'do-while' loop</td>
									<td class="cell0 table-header-cell"><input type="text" name="while" value="${whileWeight}"></td>
								</tr>
								<tr>
									<td width="50%" class="cell0 table-header-cell">The ‘switch’ statement in a switch-case control structure</td>
									<td class="cell0 table-header-cell"><input type="text" name="switch" value="${switchWeight}"></td>
								</tr>
								<tr>
									<td width="50%" class="cell0 table-header-cell">Each ‘case’ statement in a switch-case control structure</td>
									<td class="cell0 table-header-cell"><input type="text" name="case" value="${caseWeight}"></td>
								</tr>
							</table>
						</div>
						...
						<div id="wb_LayoutGrid9">
							<div id="LayoutGrid9">
								<div class="row">
									<div class="col-1"></div>
									<div class="col-2">
										<input type="submit" id="Button2" name="" value="Update Weight"
											style="display: block; width: 100%;; height: 54px; z-index: 8; cursor: pointer; font-size: 16px;">
									</div>
									<div class="col-3"></div>
								</div>
							</div>
					...
					<br/>
					<c:choose>
						<c:when test="${isSingleFile==true}">
							<table
								style="display: table; width: 100%; height: 50px; z-index: 14;"
								id="Table1">
								<tr>
									<td class="cell0 table-header-cell" colspan="6">FileName</td>
								</tr>
								<tr>
									<td width="50%" class="cell0 table-header-cell">Line</td>
									<td class="cell0 table-header-cell">Wtcs</td>
									<td class="cell0 table-header-cell">NC</td>
									<td class="cell0 table-header-cell">Ccspps</td>
									<td class="cell0 table-header-cell">Ccs</td>
									<td class="cell0 table-header-cell">Total CCs</td>
								</tr>
								<c:forEach items="${compObjs}" var="compObj">
									<tr>
										<td class="cell0 table-cell-left-aligned"><pre>${compObj.line}</pre></td>
										<td class="cell0 table-cell">${compObj.weight}</td>
										<td class="cell0 table-cell">${compObj.numberOfConds}</td>
										<td class="cell0 table-cell">${compObj.prevCcspps}</td>
										<td class="cell0 table-cell">${compObj.lineComplexity}</td>
										<td class="cell0 table-cell">${compObj.cumCcspps}</td>
									</tr>
						...
						<c:otherwise>
							<table
								...
								id="Table1">
								<tr>
									<td width="50%" class="cell0 table-header-cell">File Name</td>
									<td class="cell0 table-header-cell">LOC</td>
									<td class="cell0 table-header-cell">Complexity</td>
								</tr>
								<c:forEach items="${compFiles}" var="compFile">
									<tr>
										<td class="cell0 table-cell-left-aligned"><pre>${compFile.fileName}</pre></td>
										<td class="cell0 table-cell">${compFile.loc}</td>
										<td class="cell0 table-cell">${compFile.totComplexity}</td>
									</tr>
	...
	<script
		src="${pageContext.request.contextPath}/assets/js/jquery-1.12.4.min.js"></script>
	<script
